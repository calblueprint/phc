...
class Service < ActiveRecord::Base
  ...
  def self.services
    ...
    services = ["Acupuncture__c", "Addiction_Recovery__c", "Adult_Probation__c", "Banking__c", \
                ...
                "DMV_ID__c", "Employment__c", "Family_Services__c", "Foot_Washing__c", \
                "Groceries__c", "Haircuts__c", "HIV_STI_Testing__c", "Homeward_Bound__c", \
                "Housing_Info__c", "Legal__c", "Lifeline_Cell__c", "Fingerprints__c", "Lunch__c", "Massage__c", \
                "Medical__c", "Mental_Health__c", "Needle_Exchange__c", \
                "Pet_Care__c", "Phone_Calls__c", "Photo_Portraits__c", "Vision_Readers__c", \
                "Senior_Services__c", "SSI_SSDI_Medi_Cal__c", "Veteran_Services__c", \
                "Vision_Screening__c", "Voter_Registration__c", "Wheelchair_Repair__c", "Women_Services__c", "Youth_Services__c"]
